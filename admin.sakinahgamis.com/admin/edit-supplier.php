    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="edit-supplier.php">Tambah Supplier</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" lass="form-horizontal style-form" style="margin-top: 20px;" action="update-data-supplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <div class="row mb-3">
                  <div class="col-sm-9">
                  <input style="display: none;" name="id_supplier" type="text" id="id_supplier" class="form-control" placeholder="Id supplier" value="<?php echo $data['id_supplier']; ?>" autofocus="on"  required />
                  </div>
                </div><!-- row -->
              <!-- Horizontal Form -->
              <form>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
            <center><div class="card-title">Foto Supplier</div></center>
                
                <center>  <form role="form" lass="form-horizontal style-form" style="margin-top: 20px;" action="update-foto-supplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="databarang.php">Data Brang</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <?php
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
               ...
               <td><?php echo $data['deskripsi']; ?></td>
                ...
                <div class="text-right">
                    <a href="databarang.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
               </div> 

    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="databahan.php">Data Bahan</a></li>
          <li class="breadcrumb-item"><a href="detail-bahan.php">Detail Bahan</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <?php
        ...
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Data</button>
               ...
               <td><?php echo $data['sisa']; ?></td>
                ...
                <div class="text-right">
                    <a href="datastokbahan.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
               </div> 

            ...
            <div class="card-body">
              ...
              <form class="form-horizontal style-form" action="insert-admin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_barang" type="text" id="nama_barang" class="form-control mb-3" placeholder="nama_barang" required />
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-sm-2 control-label">Kategori</label>
                    <div class="col-sm-10">
                      <input name="kategori" type="text" id="kategori" class="form-control mb-3" placeholder="kategori" required />
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                       <input name="ukuran" type="text" id="ukuran" class="form-control mb-3" placeholder=" ukuran" required />
                   </div>
                 </div>

                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Sablon</label>   
                <div class="col-sm-10">
                  <select class="form-control mb-3" name="sablon" id="sablon"> 
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                       <input name="harga" type="text" id="harga" class="form-control mb-3" placeholder="harga" required />
                   </div>
                 </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                       <input name="stok" type="text" id="stok" class="form-control mb-3" placeholder="stok" required />
                   </div>
                 </div>

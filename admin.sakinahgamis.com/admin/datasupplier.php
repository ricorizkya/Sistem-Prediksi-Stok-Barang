...
<body>
    ...
    <main id="main" class="main">
        ...
        <?php
          $query1="select * from tb_supplier";
            ...
            <div class="br-section-wrapper" style="padding: 20px;">
                ...
                <div class="modal fade" id="UjiModal1" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalScrollableTitle">Input Data Supplier</h5>
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal style-form" action="insert-supplier.php" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input name="telp" type="text" id="telp" class="form-control mb-3"
                                                placeholder="Ex : 331904567890" required />
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          { $no++; ?>
                                            <tr>
                                                ...
                                                <td scope><?php echo $data['nama']; ?></>
                                                </td>
                                                <td scope><?php echo $data['alamat'];?>
                                                <td scope><?php echo $data['email'];?>
                                                <td scope><?php echo $data['telp'];?>
                                                <td>
                                                    <center>
                                                        ...
                                                        <div id="thanks">
                                                            ...
                                                            <a class="btn btn-sm btn-success tooltips"
                                                                ...
                                                                href="detail-supplier.php?hal=lihat&kd=<?php echo $data['id_supplier'];?>"><i
                                                                    class="far fa-address-card"></i></a>
                                                            <a class="btn btn-sm btn-primary" data-placement="bottom"
                                                                data-toggle="tooltip" title="Edit Supplier"
                                                                href="edit-supplier.php?hal=edit&kd=<?php echo $data['id_supplier'];?>"><i
                                                            ...
                                                            <a onclick="return confirm ('Yakin hapus <?php echo $data['fullname']; ?> ?');"
                                                                ...
                                                                href="hapus-supplier.php?hal=hapus&kd=<?php echo $data['id_supplier'];?>"><i
